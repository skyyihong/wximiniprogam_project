...
__DEFINE__(1688738837981, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1688738837982,"./event-store":1688738837983}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1688738837982, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1688738837983, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1688738837982,"./utils":1688738837984}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1688738837984, function(require, module, exports) {
...
return __REQUIRE__(1688738837981);
})()
